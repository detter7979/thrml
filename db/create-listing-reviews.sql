...
-- Fixes: "Could not find the table 'public.listing_reviews' in the schema cache"
--
-- Next (explore/cards star averages): run sync-listing-ratings.sql so listing_ratings stays updated from reviews.
...
-- Denormalize host_id from listing for host dashboards / profile counts
