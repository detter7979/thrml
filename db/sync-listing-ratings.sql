-- Run after create-listing-reviews.sql if explore/cards still show 0 stars.
-- Creates listing_ratings + triggers so listing_ratings(...) embeds stay in sync.
--
-- Removes a legacy VIEW/MATVIEW named listing_ratings if present (fixes "is not a table").
